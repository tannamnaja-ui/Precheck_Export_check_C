...
function testConnection() {
    ...
    const apiUrl = (apiUrlEl && apiUrlEl.value.trim()) ? apiUrlEl.value.trim().replace(/\/$/, '') : 'http://localhost:3002';
...
function saveConnection() {
    ...
    const apiUrl2 = (apiUrlEl2 && apiUrlEl2.value.trim()) ? apiUrlEl2.value.trim().replace(/\/$/, '') : 'http://localhost:3002';
